...
n = input("What do you want to stich? ")
...
while len(hodd) < len(WIDTH):
    hodd.append('__')
    hodd.append('  ')

while len(heven) < len(WIDTH):
    heven.append('  ')
    heven.append('__')
...
print("This is a hitomezashi pattern based on " + n + ".")
print("___"*len(WIDTH))
